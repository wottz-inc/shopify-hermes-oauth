...
describe('shopify-hermes-oauth Hermes skill', () => {
  ...
  it('explains safe OAuth setup, verification, reports, MCP, and skill selection', () => {
    ...
    for (const required of [
      ...
      'shopify.orders.get',
      'shopify.discounts.list/get',
      'shopify.marketing_events.list',
      'read_discounts',
      'read_marketing_events',
      'read_companies',
      'no contacts, addresses, external IDs, notes, payment terms, or full exports',
      '## Limits',
      ...
      'Lookup caps: product variants 25, media 10, metafield metadata 20',
      'inventory locations/levels page 50',
      'inventory levels require exactly one of inventoryItemId or locationId',
